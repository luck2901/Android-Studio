...
public class googlemap3 extends AppCompatActivity implements AutoPermissionsListener {
    ...
    private void showCurrentLocation(Location location) {
        LatLng curPoint = new LatLng(35.815557, 127.108028);
    ...
    private void addPictures(Location location) {
        ...
        if (marketMarker == null) {
            ...
            marketMarker.position(new LatLng(35.815557, 127.108028));
            marketMarker.title("- 메리 퀸트 -" );
            ...
            mapbutton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder myAlertBuilder = new AlertDialog.Builder(googlemap3.this);
                    // alert의 title과 Messege 세팅
                    myAlertBuilder.setTitle("- 메리 퀸트 -");
                    myAlertBuilder.setMessage("● 전화번호 : 063 - 220 - 6343\n● 영업시간 : 09:00 ~ 18:00");

                    // 버튼 추가 ( 전화걸기 버튼 )
                    myAlertBuilder.setNeutralButton("전화걸기", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:063-220-6343"));

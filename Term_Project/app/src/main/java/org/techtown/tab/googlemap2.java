...
public class googlemap2 extends AppCompatActivity implements AutoPermissionsListener {
    ...
    private void showCurrentLocation(Location location) {
        LatLng curPoint = new LatLng(35.8193271, 127.1444791);
    ...
    private void addPictures(Location location) {
        ...
        if (marketMarker == null) {
            ...
            marketMarker.position(new LatLng(35.8193271, 127.1444791));
            marketMarker.title("- NS 웨이보 -" );
            ...
            mapbutton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder myAlertBuilder = new AlertDialog.Builder(googlemap2.this);
                    // alert의 title과 Messege 세팅
                    myAlertBuilder.setTitle("- NS 웨이보 -");
                    myAlertBuilder.setMessage("● 전화번호 : 063 - 720 - 5253\n● 영업시간 : 09:00 ~ 18:00");

                    // 버튼 추가 ( 전화걸기 버튼 )
                    myAlertBuilder.setNeutralButton("전화걸기", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:063-720-5253"));

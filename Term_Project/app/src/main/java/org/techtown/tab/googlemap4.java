...
public class googlemap4 extends AppCompatActivity implements AutoPermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.googlemap4);
    ...
    private void showCurrentLocation(Location location) {
        LatLng curPoint = new LatLng(35.814351, 127.151600);
    ...
    private void addPictures(Location location) {
        ...
        if (marketMarker == null) {
            ...
            marketMarker.position(new LatLng(35.814351, 127.151600));
            marketMarker.title("- 한옥 옷가게 -" );
            ...
            mapbutton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder myAlertBuilder = new AlertDialog.Builder(googlemap4.this);
                    // alert의 title과 Messege 세팅
                    myAlertBuilder.setTitle("- 한옥 옷가게 -");
                    myAlertBuilder.setMessage("● 전화번호 : 063 - 123 - 1234\n● 영업시간 : 09:00 ~ 18:00");

                    // 버튼 추가 ( 전화걸기 버튼 )
                    myAlertBuilder.setNeutralButton("전화걸기", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:063-123-1234"));

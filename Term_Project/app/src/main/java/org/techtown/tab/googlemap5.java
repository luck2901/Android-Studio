...
public class googlemap5 extends AppCompatActivity implements AutoPermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.googlemap5);
    ...
    private void showCurrentLocation(Location location) {
        LatLng curPoint = new LatLng(35.804030, 127.124520);
    ...
    private void addPictures(Location location) {
        ...
        if (marketMarker == null) {
            ...
            marketMarker.position(new LatLng(35.804030, 127.124520));
            marketMarker.title("- 평화 멋쟁이 -" );
            ...
            mapbutton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder myAlertBuilder = new AlertDialog.Builder(googlemap5.this);
                    // alert의 title과 Messege 세팅
                    myAlertBuilder.setTitle("-평화 멋쟁이 -");
                    myAlertBuilder.setMessage("● 전화번호 : 063 - 248 - 1234\n● 영업시간 : 09:00 ~ 18:00");

                    // 버튼 추가 ( 전화걸기 버튼 )
                    myAlertBuilder.setNeutralButton("전화걸기", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:063-248-1234"));

                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {//회원등록 성공한 경우
                                ...
                                String userAge = jasonObject.getString("userAge");
                                String userHak = jasonObject.getString("userHak");
                                String userMajor = jasonObject.getString("userMajor");
                                ...
                                intent.putExtra("userHak", userHak);
